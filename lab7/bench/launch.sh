...
echo "                            ground_speed on vcan0"
echo "                            engine_speed on vcan0"
echo "                            pto_speed    on vcan0"
echo

python3 ground_speed.py -b vcan0 -s 0x40 &
python3 engine_speed.py -b vcan0 -s 0x41 &
python3 pto_speed.py    -b vcan0 -s 0x42 &
